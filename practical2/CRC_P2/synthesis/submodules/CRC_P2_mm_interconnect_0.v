// CRC_P2_mm_interconnect_0.v

// This file was auto-generated from altera_merlin_interconnect_wrapper_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 13.1 162 at 2024.04.23.14:55:10

`timescale 1 ps / 1 ps
module CRC_P2_mm_interconnect_0 (
	...
	wire  [95:0] cmd_xbar_mux_005_src_data;                                                                        // cmd_xbar_mux_005:src_data -> timer_0_s1_translator_avalon_universal_slave_0_agent:cp_data
	wire   [5:0] cmd_xbar_mux_005_src_channel;                                                                     // cmd_xbar_mux_005:src_channel -> timer_0_s1_translator_avalon_universal_slave_0_agent:cp_channel
	...
	wire  [95:0] timer_0_s1_translator_avalon_universal_slave_0_agent_rp_data;                                     // timer_0_s1_translator_avalon_universal_slave_0_agent:rp_data -> id_router_005:sink_data
	...
	CRC_P2_mm_interconnect_0_addr_router addr_router (
	...
	CRC_P2_mm_interconnect_0_addr_router_001 addr_router_001 (
	...
	CRC_P2_mm_interconnect_0_id_router id_router (
	...
	CRC_P2_mm_interconnect_0_id_router id_router_001 (
	...
	CRC_P2_mm_interconnect_0_id_router_002 id_router_002 (
	...
	CRC_P2_mm_interconnect_0_id_router_002 id_router_003 (
	...
	CRC_P2_mm_interconnect_0_id_router_002 id_router_004 (
	...
	CRC_P2_mm_interconnect_0_id_router id_router_005 (
	...
	CRC_P2_mm_interconnect_0_cmd_xbar_demux cmd_xbar_demux (
		.clk                (clock_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_cmd_xbar_demux_001 cmd_xbar_demux_001 (
		.clk                (clock_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_cmd_xbar_mux cmd_xbar_mux (
		.clk                 (clock_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_cmd_xbar_mux cmd_xbar_mux_001 (
		.clk                 (clock_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_cmd_xbar_mux_002 cmd_xbar_mux_002 (
		.clk                 (clock_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_cmd_xbar_mux_002 cmd_xbar_mux_003 (
		.clk                 (clock_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_cmd_xbar_mux_002 cmd_xbar_mux_004 (
		.clk                 (clock_clk_clk),                           //       clk.clk
		.reset               (sysid_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_cmd_xbar_mux cmd_xbar_mux_005 (
		.clk                 (clock_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_rsp_xbar_demux rsp_xbar_demux (
		.clk                (clock_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_rsp_xbar_demux rsp_xbar_demux_001 (
		.clk                (clock_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_rsp_xbar_demux_002 rsp_xbar_demux_002 (
		.clk                (clock_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_rsp_xbar_demux_002 rsp_xbar_demux_003 (
		.clk                (clock_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_rsp_xbar_demux_002 rsp_xbar_demux_004 (
		.clk                (clock_clk_clk),                           //       clk.clk
		.reset              (sysid_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_rsp_xbar_demux rsp_xbar_demux_005 (
		.clk                (clock_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (clock_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CRC_P2_mm_interconnect_0_rsp_xbar_mux_001 rsp_xbar_mux_001 (
		.clk                 (clock_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
