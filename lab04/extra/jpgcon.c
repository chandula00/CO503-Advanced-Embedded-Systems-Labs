...
void write_jpeg(const char *filename, RGB *pixelData, int width, int height)
{
...
int main()
{
    const char *bmp_filename = "resized_image.bmp";
    const char *jpeg_filename = "output_image.jpg";
    ...
    write_jpeg(jpeg_filename, pixelData, width, height);
