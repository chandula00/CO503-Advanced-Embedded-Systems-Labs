...
#define IN_BASE_2to3 0x41048
#define OUT_BASE_2to3 0x4106C
#define CONTROL_BASE_2to3 0x41000

#define IN_BASE_3to4 0x41068
#define OUT_BASE_3to4 0x21050
#define CONTROL_BASE_3to4 0x41020
