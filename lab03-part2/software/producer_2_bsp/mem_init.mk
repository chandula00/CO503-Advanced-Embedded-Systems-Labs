...
# Memory: onchip_data_memory_cpu0
MEM_0 := SoC_onchip_data_memory_cpu0
$(MEM_0)_NAME := onchip_data_memory_cpu0
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_data_memory_cpu0
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_data_memory_cpu0
onchip_data_memory_cpu0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_instruction_memory0
MEM_1 := SoC_onchip_instruction_memory0
$(MEM_1)_NAME := onchip_instruction_memory0
...
$(MEM_1)_HIERARCHICAL_PATH := onchip_instruction_memory0
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_instruction_memory0
onchip_instruction_memory0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
